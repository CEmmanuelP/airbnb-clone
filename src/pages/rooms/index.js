          ...
          <div className="detail">
            ...
            <div className="room_options">
              <div className="room_option">
                ...
                <div>
                  <div style={{ fontSize: "0.8rem", paddingBottom: "0.3rem" }}>
                    집 전체
                  </div>
          ...
          <div className="review_ratings">
            ...
            >
              <div className="reviewer">
                ...
                <div>
                  <h5 style={{ margin: "0", padding: "0 .5rem .1rem" }}>
                    아무개
                  </h5>
                  <span
                    style={{
              ...
              <div style={{ padding: "1rem 2rem 0 0", fontSize: "0.8rem" }}>
                <span>
                  덕분에 잘 쉬다가 힐링하고 값니다. 뷰가 너무 좋고^^ 가격대비
                  훌륭했습니다. 보일러가 따뜻해서 더웠어요 ㅎㅎ
                </span>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div style={{ padding: "1rem 2rem 0 0", fontSize: "0.8rem" }}>
                <span>
                  바퀴벌레가 나왔어요. 다행히도 제가 디버그를 잘하는 사람이라
                  잡았네요.
                </span>
              </div>
            </div>
            ...
            >
              ...
              <div style={{ padding: "1rem 2rem 0 0", fontSize: "0.8rem" }}>
                <span>
                  냉장고에 먹다 남은 콜라가 있네요. 더운 날 참 도움이 많이
                  되었습니다. ㅎㅎ
                </span>
              </div>
            </div>
